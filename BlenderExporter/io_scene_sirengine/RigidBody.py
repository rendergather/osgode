...
############################################################################
    def buildGraph(self):
        ...
        #self.LinearDamping = self.Object.game.damping / self.Data.Scene.game_settings.fps
        #self.AngularDamping = self.Object.game.rotation_damping / self.Data.Scene.game_settings.fps
