...
############################################################################
    def __init__(self, rigid_body, sensor):
        super(KeyboardSensor, self).__init__(rigid_body, sensor)
...
############################################################################
    def buildGraph(self):
        super(KeyboardSensor, self).buildGraph()

        self.Key = ord( self.BlenderSensor.key.lower() )
...
############################################################################
    def writeToStream(self, writer):
        ...
        writer.moveIn("ooGame::KeyboardSensor") ;

        self.writePrivateData(writer)

        writer.moveOut("ooGame::KeyboardSensor")
...
############################################################################
    def writePrivateSensorData(self, writer):
        ...
        writer.writeLine("Key 0x%x" % self.Key)
...
############################################################################
    def __init__(self, rigid_body, sensor):
        super(MessageSensor, self).__init__(rigid_body, sensor)
...
############################################################################
    def buildGraph(self):
        super(MessageSensor, self).buildGraph()

        self.Type = "TEXT"
        self.Subject = self.BlenderSensor.subject
...
############################################################################
    def writeToStream(self, writer):
        ...
        writer.moveIn("ooGame::MessageSensor") ;

        self.writePrivateData(writer)

        writer.moveOut("ooGame::MessageSensor")
