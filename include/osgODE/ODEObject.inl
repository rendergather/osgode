...
/* ....................................................................... */
inline void
osgODE::ODEObject::setInteractionCallback(osgODE::ODECallback* cbk)
{
    m_interaction_callback = cbk ;
}
/* ....................................................................... */
/* ======================================================================= */
...
/* ....................................................................... */
inline osgODE::ODECallback*
osgODE::ODEObject::getInteractionCallback(void)
{
    return m_interaction_callback.get() ;
}
/* ....................................................................... */
/* ======================================================================= */
...
/* ....................................................................... */
inline const osgODE::ODECallback*
osgODE::ODEObject::getInteractionCallback(void) const
{
    return m_interaction_callback.get() ;
}
/* ....................................................................... */
...
/* ....................................................................... */
inline void
osgODE::ODEObject::addInteractionCallback(osgODE::ODECallback* cbk)
{
    if( m_interaction_callback.valid() ) {
        m_interaction_callback->addNestedCallback(cbk) ;
    } else {
        setInteractionCallback(cbk) ;
    }
}
/* ....................................................................... */
/* ======================================================================= */
...
/* ....................................................................... */
inline void
osgODE::ODEObject::removeInteractionCallback(osgODE::ODECallback* cbk)
{
    if(cbk) {
        if( cbk == m_interaction_callback.get()) {
            m_interaction_callback = m_interaction_callback->getNestedCallback() ;
        } else {
            if( m_interaction_callback.valid() ) {
                m_interaction_callback->removeNestedCallback(cbk) ;
            }
        }
    }
}
