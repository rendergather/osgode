/*!
 * @file AddRemoveObjectOperation.cpp
...
/* ======================================================================= */
/* ....................................................................... */
RemoveObjectOperation::RemoveObjectOperation(osgODE::ODEObject* object, bool acquire_traverse_lock):
    m_object(object),
...
/* ....................................................................... */
void
RemoveObjectOperation::operator()(osgODE::World* world)
{
...
/* ======================================================================= */
/* ....................................................................... */
AddObjectOperation::AddObjectOperation(osgODE::ODEObject* object, bool acquire_traverse_lock):
    m_object(object),
    m_acquire_traverse_lock(acquire_traverse_lock)
{
}
...
/* ....................................................................... */
void
AddObjectOperation::operator()(osgODE::World* world)
{
    if( m_acquire_traverse_lock ) {
        world->traverseLock() ;
